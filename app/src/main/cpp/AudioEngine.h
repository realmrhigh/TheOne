...
private:
    ...
    double currentTickDurationMs_ = 0.0;
    double timeAccumulatedForTick_ = 0.0;
    uint32_t audioStreamSampleRate_ = 0; // To be updated when Oboe stream starts

    void RecalculateTickDuration(); // Helper for sequencer BPM/PPQN changes
