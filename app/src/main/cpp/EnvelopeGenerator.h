...
enum class ModelEnvelopeTypeInternalCpp { // FIX: Rename from EnvelopeTypeCpp
    AD,
    AHDS,
    ADSR
};
...
struct EnvelopeSettingsCpp {
    ModelEnvelopeTypeInternalCpp type = ModelEnvelopeTypeInternalCpp::ADSR; // FIX: Update to use the new enum name
    float attackMs = 5.0f;
